                                ...
                                <table class="w-full text-left border-collapse">
                                    <thead>
                                        <tr class="bg-gray-100 border-b border-gray-200">
                                            ...
                                            <th class="py-3 px-4 font-semibold text-sm text-gray-600">Keterangan /
                                                Alasan</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            <tr class="border-b border-gray-100 hover:bg-gray-50">
                                                ...
                                                <td class="py-3 px-4">
                                                    <input type="text" name="keterangan[{{ $item->id }}]"
                                                        ...
                                                        placeholder="Misal: Kedaluwarsa, Rusak..."
                        ...
                        <tbody>
                            @forelse($historySO as $history)
                                <tr class="border-b hover:bg-gray-50">
                                    <td class="py-2 px-4 font-bold text-gray-700">{{ $history->code }}</td>
                                    <td class="py-2 px-4">
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="py-4 text-center text-gray-400">Belum ada riwayat stock
                                        opname.</td>
                                </tr>
                            @endforelse
                        </tbody>
